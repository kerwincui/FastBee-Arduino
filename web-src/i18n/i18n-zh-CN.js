...
(function() {
    ...
    var zhTranslations = {
        ...
        'periph-exec-action-call-help': '调用外设 JSON，例如 {"periphId":"stepper","action":"forward"}；步进电机支持 forward/reverse/stop/faster/slower/setSpeed/direction',
        ...
        'periph-exec-action-display-value-hint': '支持 ${periphId.field} 模板（例如 ${dht_01.temperature}），将从传感器缓存取最新值',
