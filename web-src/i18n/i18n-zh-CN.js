...
(function() {
    ...
    var zhTranslations = {
        ...
        // 网络状态面板
        'network-status-title': '网络连接状态',
        'net-status-connection': '连接状态',
        ...
        'net-status-ap': 'AP模式',
        'net-mode-label': '网络模式',
        'net-ssid-label': 'WiFi名称',
        'net-ip-label': 'IP地址',
        'net-signal-label': '信号强度',
        'net-uptime-label': '连接时长',
        ...
        'device-name-hint': '热点名称为空时，自动生成 SSID：设备名称_芯片ID',
        'wifi-password-label': '密码',
        'wifi-save-ok': '网络设置保存成功！',
        'wifi-save-fail': '网络设置保存失败！',
        ...
        'dev-sys-factory-processing': '… 处理中...',
        'dev-sys-factory-btn-html': '恢复出厂设置',
        ...
        'dev-mode-title': '开发环境功能',
        'dev-mode-hint': '禁用后，外设配置、外设执行和 Modbus 子设备的新增、删除、编辑、映射入口将不可用。',
        'dev-mode-current': '当前状态：',
        'dev-mode-password-label': '登录密码：',
        'dev-mode-enabled': '已启用',
        'dev-mode-disabled': '已禁用',
        'dev-mode-disable-btn': '禁用开发环境',
        'dev-mode-enable-btn': '启用开发环境',
        'dev-mode-disabled-tip': '开发环境已禁用，请到设备配置的高级配置中启用后再修改。',
        'dev-mode-password-required': '请输入登录密码',
        'dev-mode-disable-confirm': '确定要禁用开发环境功能吗？',
        'dev-mode-enable-confirm': '确定要启用开发环境功能吗？',
        'dev-mode-disable-ok': '开发环境已禁用',
        'dev-mode-enable-ok': '开发环境已启用',
        'dev-mode-save-fail': '开发环境设置失败',
        ...
        'add-description-label': '描述',
        'add-description-placeholder': '可选，最多64字符',
        'add-user-confirm': '添加',
        'user-added': '用户添加成功！',
        ...
        // WiFi扫描
        'wifi-scanning-html': '… 扫描中...',
        'wifi-scan-btn-html': '选择Wifi网络',
        'wifi-scanning-result': '<div class="wifi-scan-state"><div class="wifi-scan-state-text">正在扫描...</div></div>',
        'wifi-scan-fail': '<div class="wifi-scan-state is-error"><div class="wifi-scan-state-text">扫描失败</div></div>',
        'wifi-scan-fail-msg': '扫描失败，请稍后重试',
        'wifi-scan-busy': '<div class="wifi-scan-state is-warning"><div class="wifi-scan-state-text">扫描正在进行中，请稍后再试</div></div>',
        'wifi-no-network': '<div class="wifi-scan-state"><div class="wifi-scan-state-text">未找到WiFi网络</div></div>',
        ...
        'dev-refresh-disabled-html': '没有网络',
        ...
        'dev-config-transfer-batch-hint': '提示：配置文件较大时可分多次选择不同文件依次导入。',
        ...
        'dev-restarting-html': '… 处理中...',
        'dev-restart-btn-html': '立即重启',
        ...
        'ota-start-fail': '启动失败',
        'ota-downloading-html': '… 下载中...',
        'ota-start-url-html': '开始在线升级',
        ...
        'ota-uploading-html': '… 上传中...',
        'ota-upload-btn-html': '上传并升级',
        ...
        'peripheral-type-lcd': 'LCD/OLED 显示屏',
        ...
        'periph-exec-action-trigger-event': '触发设备事件',
        ...
        'periph-exec-action-display-number': '显示数字',
        'periph-exec-action-display-text': '显示文本',
        'periph-exec-action-display-clear': '数码管清屏',
                'periph-exec-action-oled-display': 'OLED自定义显示',
        'periph-exec-action-cat-display': '显示屏',
        ...
        'periph-exec-sensor-cat-dht11': 'DHT11 温湿度',
        'periph-exec-sensor-cat-dht22': 'DHT22 温湿度',
        'periph-exec-sensor-cat-ds18b20': 'DS18B20 温度',
        'periph-exec-sensor-cat-ultrasonic': 'HC-SR04 超声波',
        'periph-exec-sensor-cat-current': '电流型传感器',
        'periph-exec-sensor-cat-voltage': '电压型传感器',
        'periph-exec-sensor-cat-sht31': 'SHT31 温湿度',
        'periph-exec-sensor-cat-aht20': 'AHT20 温湿度',
        'periph-exec-sensor-cat-bh1750': 'BH1750 光照',
        'periph-exec-sensor-cat-bmp280': 'BMP280 气压',
        'periph-exec-sensor-cat-mpu6050': 'MPU6050 姿态',
        'periph-exec-sensor-datafield': '数据字段',
        'periph-exec-sensor-datafield-temp': '温度',
        'periph-exec-sensor-datafield-humi': '湿度',
        'periph-exec-sensor-datafield-voltage': '电压',
        'periph-exec-sensor-datafield-current': '电流',
        'periph-exec-sensor-datafield-distance': '距离',
        'periph-exec-sensor-datafield-illuminance': '光照',
        'periph-exec-sensor-datafield-pressure': '气压',
        'periph-exec-sensor-datafield-altitude': '海拔',
        'periph-exec-sensor-datafield-value': '原始值',
        'periph-exec-sensor-devindex': '设备索引',
        ...
        'periph-exec-sensor-extra-json': '高级参数(JSON)',
        'periph-exec-sensor-extra-json-hint': '{"driverParams":{"addr":"0x44","sda":21,"scl":22}}',
        'periph-exec-sensor-extra-json-help': '可填写分压比、电流零点、I2C 地址等高级参数；留空则使用默认值。',
        'periph-exec-sensor-extra-json-invalid': '传感器高级参数必须是 JSON 对象',
        ...
        'periph-exec-event-button-periph-any': '-- 任意按键外设 --',
        ...
        'periph-exec-col-stats': '触发',
        'periph-type-driver-pending': '(待驱动)',
        ...
        'rule-script-source-topic-help': '留空匹配所有 MQTT 消息，支持 + (单级) / # (多级) 通配符',
        'rule-script-target-topic-label': '目标主题',
        'rule-script-target-topic-help': '留空不重定向，转换后发布到此主题',
        'rule-script-col-topic': '主题映射',
        ...
        'periph-opt-seven-segment': 'TM1637 数码管',
        'periph-opt-stepper': '步进电机',
        'periph-opt-neopixel': 'WS2812B 灯珠',
        'periph-opt-generic-sensor': '通用传感器',
        'periph-opt-ds1302': 'DS1302 实时时钟',
        'periph-opt-lcd1602': 'LCD1602 字符液晶',
        'ds1302-hint-title': '⏰ DS1302 实时时钟说明',
        'ds1302-hint-1': '3线接口（CE/IO/SCLK），非标准SPI',
        'ds1302-hint-2': '支持时间读取/设置，断电后由纽扣电池维持计时',
        'ds1302-hint-3': '支持涓流充电（可给超级电容充电）',
        'ds1302-hint-4': '内置31字节用户RAM可存储少量配置数据',
        'lcd1602-hint-title': '📺 LCD1602 字符液晶说明',
        'lcd1602-hint-1': 'I2C接口（通过PCF8574/PCF8574A扩展板）',
        'lcd1602-hint-2': '支持16x2和20x4字符液晶',
        'lcd1602-hint-3': '仅支持ASCII字符，不支持中文',
        'lcd1602-hint-4': '常见I2C地址：0x27（PCF8574）或0x3F（PCF8574A）',
        'generic-sensor-hint-title': '🔌 通用传感器容器说明',
        'generic-sensor-hint-1': '逻辑数据源，用于外部传感器或虚拟传感器',
        'generic-sensor-hint-2': '不代表具体物理传感器驱动',
        'generic-sensor-hint-3': '具体传感器请使用专用类型（DHT11/DS18B20/SHT31等）',
        'generic-sensor-hint-4': '可在"外设执行"中配置数据读取和上报规则',
        'stepper-params-title': '步进电机参数',
        'stepper-steps-label': '每圈步数',
        'stepper-steps-help': '28BYJ-48 + ULN2003 常用 2048 半步/圈',
        'stepper-speed-label': '默认转速 (RPM)',
        'stepper-speed-help': '建议 1-15 RPM，过高容易丢步或发热',
        'stepper-pin-hint': '引脚顺序：IN1, IN2, IN3, IN4；ULN2003 示例为 11,10,9,13',
        'encoder-params-title': '编码器参数',
        'encoder-resolution-label': '每转脉冲数',
        'encoder-resolution-help': '常用值：600, 1024, 2048, 4096',
        'encoder-interrupt-label': '使用硬件中断',
        'encoder-interrupt-help': '中断模式可提高采样精度',
        'encoder-pin-hint': '引脚顺序：A相, B相；例如 GPIO4, GPIO5',
        'sdcard-params-title': 'SD卡参数',
        'sdcard-interface-label': '接口模式',
        'sdcard-interface-help': 'SPI模式兼容性更好，SDMMC速度更快',
        'sdcard-frequency-label': '通信频率 (Hz)',
        'sdcard-frequency-help': 'SPI常用 20MHz，SDMMC可达 40MHz',
        'sdcard-pin-hint-spi': 'SPI引脚顺序：CLK, MOSI, MISO, CS',
        'sdcard-pin-hint-sdmmc': 'SDMMC引脚顺序：CMD, CLK, D0, D1, D2, D3',
        'neopixel-params-title': 'WS2812B 灯珠参数',
        'neopixel-count-label': '灯珠数量',
        'neopixel-count-help': '建议 ESP32 精简版先使用 1-16 颗，最大限制 64 颗',
        'neopixel-brightness-label': '默认亮度 (0-255)',
        'neopixel-brightness-help': '亮度越高耗电越大，测试建议 32-96',
        'neopixel-pin-hint': '引脚顺序：只填 1 个数据引脚 DIN，例如 GPIO4',
        'segment-params-title': '数码管参数',
        ...
        'peripheral-type-device-event': '设备事件',
                'device-event-hint-title': '📡 设备事件外设说明',
                'device-event-hint-1': '无GPIO引脚，纯逻辑虚拟外设',
                'device-event-hint-2': '用于触发系统事件（启动/重启/恢复出厂等）',
                'device-event-hint-3': '可在"外设执行"中配置规则触发MQTT广播',
                'device-event-hint-4': '适合作为平台触发源，联动其他设备',
