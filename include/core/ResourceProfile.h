...
static constexpr size_t MAX_PERIPHERALS = 16;
static constexpr size_t MAX_PERIPH_EXEC_RULES = 12;
...
static constexpr size_t MAX_PERIPHERALS = 32;
static constexpr size_t MAX_PERIPH_EXEC_RULES = 32;
static constexpr size_t SENSOR_CACHE_MAX_ENTRIES = 32;
#else
static constexpr const char* NAME = "esp32-slim";
static constexpr size_t MAX_PERIPHERALS = 24;
static constexpr size_t MAX_PERIPH_EXEC_RULES = 16;
