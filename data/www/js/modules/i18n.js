...
const i18n = {
    ...
    translations: {
        'zh-CN': {
            ...
            'periph-exec-operator-label': '比较运算符',
            'periph-exec-compare-label': '比较值',
            'periph-exec-compare-hint': '如: 30 或区间: 20,30',
        ...
        'en': {
            ...
            'periph-exec-operator-label': 'Operator',
            'periph-exec-compare-label': 'Compare Value',
            'periph-exec-compare-hint': 'e.g. 30 or range: 20,30',
            ...
            'modbus-master-title': 'Master Polling Config',
