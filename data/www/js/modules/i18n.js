...
const i18n = {
    ...
    translations: {
        'zh-CN': {
            ...
            'exec-title': '执行规则',
            'exec-add-btn': '新增规则',
            'exec-add-modal-title': '新增执行规则',
            'exec-edit-modal-title': '编辑执行规则',
            'exec-col-name': '名称',
            'exec-col-trigger': '触发方式',
            'exec-col-condition': '条件',
            'exec-col-action': '动作',
            'exec-col-status': '状态',
            'exec-col-ops': '操作',
            'exec-loading': '加载中...',
            'exec-no-rules': '暂无执行规则',
            'exec-name-label': '规则名称',
            'exec-name-hint': '例如: 温度过高报警',
            'exec-enabled-label': '启用',
            ...
            'exec-timer-mode-label': '定时模式',
            'exec-timer-interval': '间隔触发',
            'exec-timer-daily': '每日时间点',
            'exec-interval-label': '间隔 (秒)',
            'exec-timepoint-label': '执行时间 (HH:MM)',
            'exec-action-type-label': '动作类型',
            'exec-action-cat-gpio': 'GPIO操作',
            'exec-action-cat-analog': '模拟输出',
            'exec-action-cat-system': '系统功能',
            'exec-action-high': '设置高电平',
            'exec-action-low': '设置低电平',
            'exec-action-blink': '闪烁',
            'exec-action-breathe': '呼吸灯',
            'exec-action-pwm': '设置PWM',
            'exec-action-dac': '设置DAC',
            'exec-action-restart': '系统重启',
            'exec-action-factory': '恢复出厂',
            'exec-action-ntp': 'NTP同步',
            'exec-action-ota': 'OTA升级',
            'exec-action-ap': 'AP配网',
            'exec-action-ble': 'BLE配网',
            'exec-action-call-periph': '调用外设',
            'exec-target-periph-label': '目标外设',
            'exec-select-periph': '-- 选择外设 --',
            ...
            'exec-save-fail': '保存失败',
            'exec-delete-ok': '规则已删除',
            'exec-delete-fail': '删除失败',
            'exec-confirm-delete': '确定要删除此规则吗？',
            'exec-enable': '启用',
            'exec-disable': '禁用',
            'exec-toggle-fail': '状态切换失败',
            'exec-every': '每隔',
            'exec-daily': '每日',
            'periph-exec-rules-title': '执行规则',
            'periph-exec-save-first': '请先保存外设后再添加执行规则',
            'periph-exec-no-rules': '该外设暂无关联的执行规则',
        ...
        'en': {
            ...
            // Execution Rules
            'exec-title': 'Execution Rules',
            'exec-add-btn': 'Add Rule',
            'exec-add-modal-title': 'Add Execution Rule',
            'exec-edit-modal-title': 'Edit Execution Rule',
            'exec-col-name': 'Name',
            'exec-col-trigger': 'Trigger',
            'exec-col-condition': 'Condition',
            'exec-col-action': 'Action',
            'exec-col-status': 'Status',
            'exec-col-ops': 'Operations',
            'exec-loading': 'Loading...',
            'exec-no-rules': 'No execution rules',
            'exec-name-label': 'Rule Name',
            'exec-name-hint': 'e.g. Temperature Alert',
            'exec-enabled-label': 'Enabled',
            ...
            'exec-timer-mode-label': 'Timer Mode',
            'exec-timer-interval': 'Interval',
            'exec-timer-daily': 'Daily Time',
            'exec-interval-label': 'Interval (sec)',
            'exec-timepoint-label': 'Time (HH:MM)',
            'exec-action-type-label': 'Action Type',
            'exec-action-cat-gpio': 'GPIO Operations',
            'exec-action-cat-analog': 'Analog Output',
            'exec-action-cat-system': 'System Functions',
            'exec-action-high': 'Set HIGH',
            'exec-action-low': 'Set LOW',
            'exec-action-blink': 'Blink',
            'exec-action-breathe': 'Breathe',
            'exec-action-pwm': 'Set PWM',
            'exec-action-dac': 'Set DAC',
            'exec-action-restart': 'Restart',
            'exec-action-factory': 'Factory Reset',
            'exec-action-ntp': 'NTP Sync',
            'exec-action-ota': 'OTA Update',
            'exec-action-ap': 'AP Provision',
            'exec-action-ble': 'BLE Provision',
            'exec-action-call-periph': 'Call Peripheral',
            'exec-target-periph-label': 'Target Peripheral',
            'exec-select-periph': '-- Select Peripheral --',
            ...
            'exec-save-fail': 'Save failed',
            'exec-delete-ok': 'Rule deleted',
            'exec-delete-fail': 'Delete failed',
            'exec-confirm-delete': 'Are you sure to delete this rule?',
            'exec-enable': 'Enable',
            'exec-disable': 'Disable',
            'exec-toggle-fail': 'Toggle failed',
            'exec-every': 'Every',
            'exec-daily': 'Daily',
            'periph-exec-rules-title': 'Execution Rules',
            'periph-exec-save-first': 'Save peripheral first to add rules',
            'periph-exec-no-rules': 'No execution rules for this peripheral',
