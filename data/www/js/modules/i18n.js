...
const i18n = {
    ...
    translations: {
        'zh-CN': {
            ...
            'periph-exec-target-periph-label': '目标外设',
            ...
            'rule-script-col-transform': '格式转换',
            'rule-script-col-topic': '主题',
            ...
            'rule-script-trigger-sub': '订阅主题触发',
            'rule-script-trigger-pub': '发布主题拦截',
            'rule-script-source-topic-label': '源主题',
            'rule-script-source-topic-help': '触发规则的输入主题',
            'rule-script-target-topic-label': '目标主题',
            'rule-script-target-topic-help': '转换后发布到的目标主题',
            'rule-script-transform-type-label': '格式转换',
            'rule-script-transform-none': '不转换',
            'rule-script-transform-a2o': '数组 → 对象',
            'rule-script-transform-o2a': '对象 → 数组',
            'rule-script-transform-help': '数组→对象: [{id,value}]→{id:value}; 对象→数组: 反向',
            'rule-script-preview-label': '转换预览',
            'rule-script-preview-btn': '预览',
            'rule-script-select-topic': '选择主题',
        ...
        'en': {
            ...
            'periph-exec-col-target': 'Target Peripheral',
            ...
            'rule-script-col-transform': 'Transform',
            'rule-script-col-topic': 'Topic',
            ...
            'rule-script-trigger-sub': 'Subscribe Topic Trigger',
            'rule-script-trigger-pub': 'Publish Topic Intercept',
            'rule-script-source-topic-label': 'Source Topic',
            'rule-script-source-topic-help': 'Input topic that triggers the rule',
            'rule-script-target-topic-label': 'Target Topic',
            'rule-script-target-topic-help': 'Publish converted data to this topic',
            'rule-script-transform-type-label': 'Format Transform',
            'rule-script-transform-none': 'None',
            'rule-script-transform-a2o': 'Array → Object',
            'rule-script-transform-o2a': 'Object → Array',
            'rule-script-transform-help': 'Array→Object: [{id,value}]→{id:value}; Object→Array: reverse',
            'rule-script-preview-label': 'Transform Preview',
            'rule-script-preview-btn': 'Preview',
            'rule-script-select-topic': 'Select Topic',
